...
# 2. Paths (EDIT HERE)
# -----------------------------
input_csv <- "D:/NASA_Power_Kanha_Metdata_2005_2006/Data_Table/data_meteorology/gl1_kanha_ndvi_meteorology.csv"
plot_dir  <- "D:/NASA_Power_Kanha_Metdata_2005_2006/Plots/gl1_kanha_plots"
